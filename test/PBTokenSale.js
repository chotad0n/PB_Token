...
contract('PBTokenSale', function(accounts){
  var tokenSaleInstance;
  var tokenPrice = 1000000000000000; //in wei(how we keep track of ethereum in solidity(smallet subdivision of ether))
  var tokenInstance;
  ...
  it('initializes the contract with correct values',function(){
  	return PBTokenSale.deployed().then(function(instance){
